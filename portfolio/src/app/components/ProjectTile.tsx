...
export default function ProjectTile({ project }: { project: Project }) {
    return (
        <div className=" max-w-sm w-fit bg-box rounded-lg shadow-md p-4 flex flex-col items-center h-[420px]">
            ...
            />
            <p className="w-[300px] overflow-auto ">{project.description}</p>
